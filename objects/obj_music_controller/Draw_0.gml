...
var karma_color = c_maroon;
var hp_color = c_aqua;

switch (global.music_index[0]) {
	case 0:
		karma_color = (global.music_index[1] == 100) ? c_fuchsia : c_red;
		hp_color = c_yellow;
		break;

	case 1:
		switch (global.music_index[1]) {
			case 8:
			case 11:
				hp_color = c_lime;
				break;
	...
	case 4:
		switch (global.music_index[1] + 38) {
			case 46:
				hp_color = c_yellow;
				break;
			case 73:
