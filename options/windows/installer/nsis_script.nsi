...
; Seção opcional para abrir o programa ao iniciar o Windows
Section "Run at Startup" SEC_RUNSTARTUP

	; Cria um atalho no registro para iniciar o programa com o Windows
	WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Run" "${APP_NAME}" "$INSTDIR\${EXE_NAME}.exe"
...
Section UnInstall
		...
		; Remove a entrada de inicialização automática
